...
const typeNum = (arr) => {
  ...
  let finalNumber = arr.filter(newNumber);
  return finalNumber;
};
...
const containsAnd = (arr) => {
  const onlyAnd = arr.filter((words) => {
...
const oddValues = (arr) => {
  let oddOnly = arr.filter(numbers => numbers%2);
  return oddOnly;
};
...
const filterStringsWithVowels = (arr) => {
  const onlyVowels = arr.filter((words) => {
    return words.includes('a', 'e', 'i', 'o', 'u', 'y');
  });
  return onlyVowels;
};
